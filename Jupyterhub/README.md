Prior to using Jupyterhub, you will have had to have logged into Peregrine via the command line at least once.

Given that, to start using Jupyterhub, go to https://io.hpc.nrel.gov:8000 in your local machine's browser, and log in with your Peregrine username and password.
You should land in your Peregrine home directory, and see everything there via the standard Jupyter file listing.
...
## Using Jupyterhub from Peregrine

To use inside Peregrine, the Jupyterhub server exists on the internal network @ https://io-int:8000/.
